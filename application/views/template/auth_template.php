...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/propios-auth.css') ?>">
    
    <link rel="stylesheet" href="<?php echo base_url('assets/css/skins/'.$settings->skin.'-login.css') ?>">
