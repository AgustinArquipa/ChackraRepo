    ...
    <body class="<?php echo $settings->skin ?> fixed">
        ...
        <div class="wrapper">  
            <header class="main-header">
                <a href="<?php echo site_url('crud/index') ?>" class="logo">
                   ...
                   <span class="logo-lg"><b>Atrapautos</b>.com</span>
                </a>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2014-2015 <a href="#"><?= $desarrollador ?></a>.</strong> Derechos reservados.
            </footer>
        </div><!-- ./wrapper -->
        ...
        <script>
            ...
            function datatablesOptions() { var option = { 
                <?php 
                        if ($this->uri->segment(1) != 'crud'){
                        
                ?>
                    "processing": true,
                    "serverSide": true,
                    "ajax": "<?php echo base_url('assets/actions/server_processing.php?tabla=' . $this->uri->segment(2)) ?>",
                    //"ajax": "<?php echo base_url('server_processing/'.$this->uri->segment(2) .'/'. $this->uri->segment(3)) ?>",
                <?php
                    }
                ?>
                "orderClasses": false, 
