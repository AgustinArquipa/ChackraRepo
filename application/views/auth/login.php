<div class="login-box">
    <div class="login-logo">
        <img src="<?php echo base_url('assets/img/logo_qps.png') ?>">
    </div><!-- /.login-logo -->
    ...
    $('form').on('submit',function(event){
        ...
        $.ajax({
            ...
            success  : function(data) {
                if (data == 'vencido'){
                     $('.message').html('<div class="alert alert-danger">Su Cuenta se encuentra Vencida</div>').hide().slideDown();
                }else if (data == "false") {
                    $('.message').html('<div class="alert alert-danger">Datos Erroneos!</div>').hide().slideDown();
                    $('input').val('');
