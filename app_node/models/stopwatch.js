...
Stopwatch.prototype.stop = function() {  
    ...
    if (this.interval) {
        ...
        this.interval = undefined;
        this.emit('stop:stopwatch-'+this.id);
    }
};

Stopwatch.prototype.reset = function(item) {  
    console.log('Resetting Stopwatch!');
    this.time = this.time_base;
    this.emit('reset:stopwatch-'+item, this.formatTime(this.time));
};

Stopwatch.prototype.moretime = function (){
    if (this.time < 10000){
        this.time = 11000;    
    }else{
